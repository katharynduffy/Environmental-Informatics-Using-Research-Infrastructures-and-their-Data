...
```{r, echo=FALSE}
knitr::include_graphics('/Users/kdw223/Research/katharynduffy.github.io/images/Screen Shot 2020-08-31 at 8.15.42 AM.png')
```
...
```{r, echo=FALSE}
knitr::include_graphics('./images/Screen Shot 2020-09-09 at 12.49.33 PM.png')
```
