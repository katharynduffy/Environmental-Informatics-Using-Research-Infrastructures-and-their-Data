...
```{r, echo=FALSE}
knitr::include_graphics('/Users/kdw223/Research/katharynduffy.github.io/images/700phenology.jpg')
```
...
```{r, echo=FALSE}
knitr::include_graphics('./images/cens1.png')
```
...
```{r, echo=FALSE}
knitr::include_graphics('./images/cens2.png')
```
