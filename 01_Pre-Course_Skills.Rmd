...
If you are learning these skills from scratch I estimate that you will need to devote ~4-6 hours to get set up and comfortable with the various workflows.  Alo remember that I have code office hours every week and that Stack Exchange is your friend.
...
2. Git clone our [course Github Repository](https://github.com/katharynduffy/katharynduffy.github.io), navigate to the 'Exercises' folder, and use that .Rmd as a template.
