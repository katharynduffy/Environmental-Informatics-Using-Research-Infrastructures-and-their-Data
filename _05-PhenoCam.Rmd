...
```{r plot-foggy-clear, fig.height=8, fig.width=8, message=FALSE, eval=TRUE}
top10_high_haze <-  haze_mat[order(haze), file][1:3]
top10_low_haze <-  haze_mat[order(-haze), file][1:3]
...
mtext('Top images with low (right) and high (left) haze values at Point Reyes', font = 2, outer = TRUE)
...
![xROI User Interface](docs/images/xROI.png)
...
![xROI published in ISPRS Journal of Photogrammetry and Remote Sensing, 2019](docs/images/xROI-ms2019.png)
